(function() {
    ...
    Particle.prototype.position = function() {
        ...
        this.y + this.velocityY > this.h && this.velocityY > 0 || this.y + this.velocityY < 0 && this.velocityY < 0 ? this.velocityY *= -1 : this.velocityY;
        this.x += this.velocityX;
        this.y += this.velocityY;
    }
    Particle.prototype.reDraw = function() {
        this.ctxBG.beginPath();
        this.ctxBG.arc(this.x, this.y, this.properties.particleRadius, 0, Math.PI * 2);
